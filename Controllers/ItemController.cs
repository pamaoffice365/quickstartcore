...
#pragma warning restore 1998
        ...
        public async Task<ActionResult> CreateAsync([Bind("Id,Name,Description,Completed,done")] Item item)
        {
        ...
        [ActionName("Edit")]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> EditAsync([Bind("Id,Name,Description,Completed,done")] Item item)
        {
            if (ModelState.IsValid)
            {
